...
ShopCodeOffsets_s Nooklings[5] = {{0x84,0x88,0x5C,0x26C,true, false},{0x10C,0xFC,0xCC,0x26C,false, true},{0x168,0x16C,0x140,0x26C,true, false},{0x1F0,0x1E0,0x1B0,0x26C,false, true},{0x24C,0x250,0x224,0x26C,true, false}};
...
const Patch  Patch::AlwaysXmasTrees(0x106262, 0x106262, 0x106262, 0x106262, 0x106262, 0x106266, 0x106262, WAKOR, 0x1C002000); //Thumb; Pattern: F8 B5 7B 21 14 46 06 9E + 0xA
